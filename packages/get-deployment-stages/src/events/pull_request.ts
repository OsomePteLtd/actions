...
export const on = async (event: Webhooks.WebhookPayloadPullRequest, context: Context) => {
  const { action } = event;
...
const onPullRequest = async (event: Webhooks.WebhookPayloadPullRequest, context: Context) => {
  const {
    pull_request: {
      head: { ref },
      labels,
...
const onPullRequestClosed = async (event: Webhooks.WebhookPayloadPullRequest, context: Context) => {
  const {
    pull_request: {
      head: { ref },
    },
